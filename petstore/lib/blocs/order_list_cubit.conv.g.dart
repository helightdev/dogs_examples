...
class OrdersStateConverter extends gen.DefaultStructureConverter<gen2.OrdersState> {
  OrdersStateConverter()
      : super(
            struct: const gen.DogStructure<gen2.OrdersState>(
                ...
                [
                  gen.DogStructureField(gen.QualifiedTypeTreeN<gen0.List<gen1.Order>, gen0.List<dynamic>>([gen.QualifiedTerminal<gen1.Order>()]), gen.TypeToken<gen1.Order>(), null,
                      gen.IterableKind.list, 'orders', false, true, []),
                ...
                [],
                gen.ObjectFactoryStructureProxy<gen2.OrdersState>(_activator, [_$orders, _$loading, _$error], _values, _hash, _equals)));
  ...
  static List<dynamic> _values(gen2.OrdersState obj) => [obj.orders, obj.loading, obj.error];

  static gen2.OrdersState _activator(List list) {
    return gen2.OrdersState(orders: list[0].cast<gen1.Order>(), loading: list[1], error: list[2]);
  }

  static int _hash(gen2.OrdersState obj) => gen.deepEquality.hash(obj.orders) ^ obj.loading.hashCode ^ obj.error.hashCode;

  static bool _equals(
    gen2.OrdersState a,
    gen2.OrdersState b,
  ) =>
      (gen.deepEquality.equals(a.orders, b.orders) && a.loading == b.loading && a.error == b.error);
}
